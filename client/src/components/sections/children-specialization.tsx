    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        <div className="w-16 h-16 bg-purple-primary bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-6">
          <Baby className="w-8 h-8 text-purple-primary" />
        </div>
        ...
        <Link 
          href="/contact"
          className="bg-purple-primary text-white px-8 py-3 rounded-lg font-medium hover:bg-purple-800 transition-colors duration-200 inline-block"
        >
