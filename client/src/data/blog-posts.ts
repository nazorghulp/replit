...
export const blogPosts: BlogPost[] = [
  {
    id: "1",
    slug: "welkom-bij-kazenra-nederland-rouw-kent-geen-script",
    title: "Welkom bij Kazenra Nederland – Rouw kent geen script",
    metaTitle: "Welkom bij Kazenra Nederland - Persoonlijke Rouwbegeleiding | Nazorghulp.nl",
    metaDescription: "Ontdek Kazenra Nederland: flexibele en laagdrempelige rouwbegeleiding zonder wachtlijsten. Voor volwassenen en kinderen, op jouw manier en in jouw tempo.",
    excerpt: "Bij Kazenra Nederland geloven we dat rouw geen handleiding volgt. Er is geen 'standaardtraject' dat begint bij verdriet en eindigt bij verwerking. Iedereen beleeft verlies op zijn eigen manier.",
    content: `
      <h1>Welkom bij Kazenra Nederland: Rouw kent geen script</h1>
      
      <h2>Wat betekent rouwbegeleiding bij Kazenra Nederland?</h2>
      <p>Bij Kazenra Nederland geloven we dat rouw geen handleiding volgt. Er is geen "standaardtraject" dat begint bij verdriet en eindigt bij verwerking. Iedereen beleeft verlies op zijn eigen manier. Soms heftig, soms stil. Soms direct, en soms… pas een jaar later, midden in de supermarkt bij het zien van een blik bruine bonen dat aan oma doet denken.</p>
      ...
      <p>Kazenra Nederland is opgezet om een laagdrempelige, persoonlijke en flexibele vorm van begeleiding te bieden. Geen wachtlijsten. Geen volle wachtkamers. Geen verwijzingen. Bij ons kun je gewoon beginnen. Via WhatsApp, telefoon of beeldbellen. Op jouw manier. In jouw tempo.</p>
      ...
      <p>Soms praten we over verlies. Soms juist niet. Soms gaat het gesprek over hoe je je brood weer proeft zonder schuldgevoel. Of over wat je zegt als iemand vraagt: "Ben je er al een beetje overheen?" Bij Kazenra Nederland mag alles besproken worden, ook de dingen die je denkt dat 'niet normaal' zijn om te voelen.</p>
    ...
    `,
    author: "Kazenra Nederland Team",
    date: "Juli 2025",
    publishedDate: "2025-07-15",
    readTime: "6 min",
    image: blogImagePath,
    alt: "Welkom bij Kazenra Nederland - persoonlijke en flexibele rouwbegeleiding op afstand",
  ...
  },
  {
    ...
    metaTitle: "Ik wil helemaal niks - Anonieme Begeleiding voor Jongeren | Kazenra Nederland",
    ...
    content: `
      ...
      <h2>Vanuit wanhoop kwam ze bij Kazenra Nederland</h2>
      <p>De moeder vond ons via internet en ze bekeek de website van Kazenra Nederland en merkte dat we ook op afstand werken, via WhatsApp, zonder verplicht sessies. Ze stuurde ons een lange mail, vol frustratie en verdriet. Niet voor zichzelf, maar omdat ze haar dochter niet meer herkende.</p>

      <p>"Ik weet niet of dit mag, of dit werkt… maar kunnen jullie contact leggen met haar, zonder dat ze weet wie of wat jullie zijn?". We stelden voor om het volledig anoniem te doen. Geen openlijke sessies, geen 'dit is Kazenra Nederland', gewoon neutraal, een anoniem appmaatje.</p>
      ...
      <p>Dat is waarom we bij Kazenra Nederland ook dit soort trajecten doen. Niet alles hoeft in hokjes te passen en zeker niet als het gaat om kinderen en jongeren die rouwen op hun eigen, ongrijpbare manier.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Haar ouders zeggen dat ze Kazenra Nederland zien als een reddingslijn, niet alleen voor hun dochter, maar ook voor henzelf.</p>
      ...
      <p>Bij Kazenra Nederland begrijpen we dat jongeren anders rouwen dan volwassenen. We bieden daarom speciale begeleiding aan voor kinderen en tieners tot 18 jaar, altijd afgestemd op hun eigen tempo en behoeften.</p>
    `,
    author: "Kazenra Nederland Team",
    date: "Augustus 2025",
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Het contact met Kazenra Nederland</h2>
  ...
  },
  {
    ...
    content: `
      ...
      <p>"Ik weet niet of ik dit goed doe, maar ik heb hulp nodig". Ze had ons nummer via een buurvrouw gekregen. Een aantekening op een briefje: Kazenra Nederland, hulp bij verdriet, ook via telefoon. Geen WhatsApp, want daar snapte ze niks van. Geen e-mail, want "ik weet wel waar de knopjes zitten, maar niet wat ze doen."</p>
